...
const fakeData: TaskCard[] = [
  ...
  { title: 'Finish report for meeting', category: 'work', id: 2, description: 'DescriptionDescriptionDescriptionDescription', dueDate: '2024-11-05', priority: 'middle priority', status: 'to do' },
  ...
  { title: 'Read a book for an hour', category: 'hobbies', id: 14, description: 'DescriptionDescriptionDescriptionDescription', dueDate: '2024-11-05', priority: 'middle priority', status: 'to do' },
  { title: 'Watch "The Shawshank Redemption"', category: 'movies', id: 15, description: 'DescriptionDescriptionDescriptionDescription', dueDate: '2024-11-05', priority: 'low priority', status: 'to do' },
  ...
  { title: 'Attend team meeting', category: 'work', id: 17, description: 'DescriptionDescriptionDescriptionDescription', dueDate: '2024-11-05', priority: 'middle priority', status: 'to do' },
  ...
  { title: 'Practice photography skills', category: 'hobbies', id: 19, description: 'DescriptionDescriptionDescriptionDescription', dueDate: '2024-11-05', priority: 'middle priority', status: 'to do' },
  { title: 'Watch "Pulp Fiction"', category: 'movies', id: 20, description: 'DescriptionDescriptionDescriptionDescription', dueDate: '2024-11-05', priority: 'low priority', status: 'to do' },
];
